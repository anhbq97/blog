...
<div class="home_content">
  <div class="post_category trans_200"><a href="category.html" class="trans_200">Phụ Kiện</a></div>
  <div class="post_title">Review phụ kiện chất lượng cho điện thoại của bạn.</div>
</div>
@endsection
...
@section('main-content')
  <div class="post_content">
    ...
    <div class="post_panel post_panel_top d-flex flex-row align-items-center justify-content-start">
      ...
      <div class="post_meta"><a href="#">Admin</a><span>Sep 29, 2020 at 9:48 am</span></div>
    ...
    <div class="post_body">
      <p class="post_p">Vậy là sau một thời gian tích góp thì tôi cũng đã xắm cho mình 1 con iphone 11 pờ rồ mắc, công nhận là với 1 thằng sinh viên nghèo vừa ra trường như tôi thì đúng là mắc vãi nồi. Rút được bài học từ con điện thoại ghẻ lần trước, tôi đã xắm ngay cho mình 1 chiếc ốp với tâm lý của người mới mua máy.</p>
      <figure>
        <img src="{{ asset('/blog/images/casephone') }}/171891847_772112130365092_2758352551908499224_n.jpg" alt="">
        <figcaption>Chọn mãi chọn lui thì cuối cùng... Quá đẹp!!</figcaption>
      </figure>
      <p class="post_p">Các ông thấy ổn không, Cho các ông xem ảnh thật này.</p>
      <figure>
        <img src="{{ asset('/blog/images/casephone') }}/192107005_808851660002111_3472893007716465100_n.jpg" alt="">
        <figcaption>Giá rẻ lại còn chất lượng.</figcaption>
      </figure>
      <p class="post_p">Mà được cái em bán ốp còn xinh nữa. Đúng là Không phí thời gian</p>
      <p class="post_p">Vậy là yên tâm rồi, Chứ máy đắt lỡ tay đo đường phát thì sót xa lắmmm. Bye bye</p>
     <!-- Flickity HTML init -->
     <p class="post_p">DANH SÁCH ỐP</p>
      <div class="gallery js-flickity"
        data-flickity-options='{ "wrapAround": true }'>
        <div class="gallery-cell" style="background-image:url({{ asset('/blog/images/casephone') }}/168968273_909363219898168_7600530369161907711_n.jpg)"></div>
        <div class="gallery-cell" style="background-image:url({{ asset('/blog/images/casephone') }}/87896811_214466739674300_7740089584939171840_n.jpg)"></div>
        <div class="gallery-cell" style="background-image:url({{ asset('/blog/images/casephone') }}/173047111_2551941418442383_2031310556806363139_n.jpg)"></div>
        <div class="gallery-cell" style="background-image:url({{ asset('/blog/images/casephone') }}/171891847_772112130365092_2758352551908499224_n.jpg)"></div>
        <div class="gallery-cell" style="background-image:url({{ asset('/blog/images/casephone') }}/166399940_898094847694650_2380695714116987071_n.jpg)"></div>
        <div class="gallery-cell" style="background-image:url({{ asset('/blog/images/casephone') }}/116693191_895077071015294_9101400317542142486_n.jpg)"></div>
      </div>
